<template>
	<main id="home">
		<div class="persona background_size--cover background_repeat--no-repeat container_flex--center flex_direction--row">
			<div class="hero container padding--all-unit text_align--center text_color--light">
